...
namespace FitnessCenterManagementSystem.Controllers
{
    ...
    public class AppointmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TrainerId,UserId,ServiceId,StartAt,EndAt,IsConfirmed,Price")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TrainerId,UserId,ServiceId,StartAt,EndAt,IsConfirmed,Price")] Appointment appointment)
        {
