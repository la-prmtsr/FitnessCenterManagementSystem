...
namespace FitnessCenterManagementSystem.Controllers
{
    ...
    public class FitnessCentersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,OpeningHours")] FitnessCenter fitnessCenter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,OpeningHours")] FitnessCenter fitnessCenter)
        {
